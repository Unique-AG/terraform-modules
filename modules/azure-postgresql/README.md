...
| <a name="input_auto_grow_enabled"></a> [auto\_grow\_enabled](#input\_auto\_grow\_enabled) | Specifies whether the PostgreSQL Flexible Server should be automatically grow the storage. Defaults to true | `string` | `true` | no |
