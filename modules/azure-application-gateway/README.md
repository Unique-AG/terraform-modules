...
| <a name="input_waf_ip_allow_list"></a> [waf\_ip\_allow\_list](#input\_waf\_ip\_allow\_list) | Map of IP addresses for custom rules | <pre>map(object({<br/>    allow_list = list(string)<br/>  }))</pre> | `{}` | no |
