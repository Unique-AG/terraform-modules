...
|------|-------------|------|---------|:--------:|
| <a name="input_ai_defender_settings"></a> [ai\_defender\_settings](#input\_ai\_defender\_settings) | Settings for Defender for AI | <pre>object({<br/>    enabled = optional(bool, true)<br/>    tier    = optional(string, "Standard")<br/>    extensions = optional(list(object({<br/>      name                            = string<br/>      additional_extension_properties = optional(map(string))<br/>    })), [])<br/>  })</pre> | `{}` | no |
