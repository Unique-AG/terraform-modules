...
output "agic_identity_client_id" {
  ...
  value       = var.application_gateway_id != null ? azurerm_kubernetes_cluster.cluster.ingress_application_gateway[0].ingress_application_gateway_identity[0].client_id : null
}
...
output "agic_identity_object_id" {
  ...
  value       = var.application_gateway_id != null ? azurerm_kubernetes_cluster.cluster.ingress_application_gateway[0].ingress_application_gateway_identity[0].object_id : null
}
