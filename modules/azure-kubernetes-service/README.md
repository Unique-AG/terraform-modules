...
| <a name="input_default_action_group_ids"></a> [default\_action\_group\_ids](#input\_default\_action\_group\_ids) | List of action group IDs to use for alerts that don't have explicit actions defined. Required to receive alert notifications. | `list(string)` | `[]` | no |
