...
| <a name="input_basic_log_tables"></a> [basic\_log\_tables](#input\_basic\_log\_tables) | Log Analytics tables to configure with the basic log plan. | `list(string)` | <pre>[<br/>  "ContainerLogV2",<br/>  "AKSControlPlane"<br/>]</pre> | no |
...
| <a name="input_diagnostic_logs_categories"></a> [diagnostic\_logs\_categories](#input\_diagnostic\_logs\_categories) | AKS diagnostic log categories to enable. See https://learn.microsoft.com/en-gb/azure/aks/monitor-aks-reference#resource-logs | `list(string)` | <pre>[<br/>  "cloud-controller-manager",<br/>  "cluster-autoscaler",<br/>  "csi-azuredisk-controller",<br/>  "csi-azurefile-controller",<br/>  "csi-snapshot-controller",<br/>  "kube-audit-admin",<br/>  "kube-scheduler"<br/>]</pre> | no |
