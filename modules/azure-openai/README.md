...
| <a name="input_customer_managed_key"></a> [customer\_managed\_key](#input\_customer\_managed\_key) | Customer managed key for the Cognitive Account | <pre>object({<br/>    key_vault_key_id   = string<br/>    identity_client_id = string<br/>  })</pre> | `null` | no |
...
| <a name="input_network_acls"></a> [network\_acls](#input\_network\_acls) | Network ACLs for the Cognitive Account | <pre>object({<br/>    subnet_ids = list(string)<br/>    ip_rules   = list(string)<br/>  })</pre> | `null` | no |
