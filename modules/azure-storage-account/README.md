...
| <a name="input_https_traffic_only_enabled"></a> [https\_traffic\_only\_enabled](#input\_https\_traffic\_only\_enabled) | Require HTTPS for REST traffic. Must be set to false for NFS Azure File shares, which do not support in-protocol TLS. | `bool` | `true` | no |
