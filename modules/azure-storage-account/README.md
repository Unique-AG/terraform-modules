...
| <a name="input_private_endpoint"></a> [private\_endpoint](#input\_private\_endpoint) | Configuration for private endpoint | <pre>object({<br/>    subnet_id           = string<br/>    private_dns_zone_id = string<br/>    resource_group_name = string<br/>    location            = optional(string)<br/>    subresource_names   = optional(list(string), ["blob"])<br/>    tags                = optional(map(string), {})<br/>  })</pre> | `null` | no |
